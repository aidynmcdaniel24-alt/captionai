          ...
          <div className="flex flex-col gap-3">
            {nav.map((item) => (
              <a
                key={item.href}
                href={item.href}
                className="rounded-lg py-2 text-zinc-300"
            ...
            {!isLoaded ? (
              <div className="h-11 animate-pulse rounded-full bg-zinc-800" aria-hidden />
            ) : isSignedIn ? (
              <Link
                href="/dashboard"
              ...
              <>
                <Link href="/sign-in" className="py-2 text-zinc-300" onClick={() => setOpen(false)}>
                  Sign in
                </Link>
                <Link
                  href="/sign-up"
